...
String nombresTitular, apellidosTitular;
int númeroCuenta;
...
System.out.println("la cuenta actual es mayor o igual al saldo de la cuenta pasada como parametro.");
} else {
System.out.println("la cuenta actual es menor al saldo de la cuenta pasada como parametro.");
 }
}
